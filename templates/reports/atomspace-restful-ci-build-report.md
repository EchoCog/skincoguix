# CI Build Success / (Failure) Report: atomspace-restful
...
### **Additional Notes**
Component: atomspace-restful
Repository Path: repos/atomspace-restful
...
**Labels**: `ci`, `build-failure`, `bug`, `atomspace-restful`
